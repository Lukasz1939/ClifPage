                    ...
                    <div class="u-size-30">
                        <div class="u-layout-row">
                            ...
                            <div class="u-align-left u-container-style u-hidden-sm u-hidden-xs u-layout-cell u-right-cell u-size-20 u-layout-cell-4">
                                <div class="u-container-layout u-valign-top u-container-layout-4"><h5 class="u-text u-text-body-alt-color u-text-5">Plumbing<br>
                                </h5>
                                </div>
                            </div>
                        </div>
    ...
    <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
        ...
        <table class="price-table">
            ...
            <c:forEach items="${materials}" var="material">
                <tr>${material.getName()}</tr>
                <tr>${material.get2cmPrice()}</tr>
                <tr>${material.get3cmPrice()}</tr>
            </c:forEach>
            </tbody>
        </table>
    </div>
